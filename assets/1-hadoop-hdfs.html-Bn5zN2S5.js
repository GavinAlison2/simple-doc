import{_ as n,c as a,d as e,o as i}from"./app-CJbkZlV7.js";const l={};function d(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="hdfs" tabindex="-1"><a class="header-anchor" href="#hdfs"><span>HDFS</span></a></h1><blockquote><p>hadoop 永远都是这些东西在这里，那就收集一下吧。</p><ol><li>存储， hdfs</li><li>分布式计算，mapreduce</li><li>调度 yarn</li><li>读写流程</li></ol></blockquote><blockquote><p>问题：hdfs读写原理，读写流程，hdfs原理，hdfs读写机制，介绍一下hdfs存数据原理，hdfs的put和get流程</p></blockquote><h2 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h2><ul><li>Hadoop quick start</li><li>hadoop 的特点</li><li>hadoop 生态圈组件及其作用</li><li>Hadoop 1.x，2x，3.x 的区别</li><li>Hadoop 集群工作时启动哪些进程,它们有什么作用</li><li>在集群计算的时候，什么是集群的主要瓶颈</li><li>搭建Hadoop 集群的 xml 文件有哪些</li><li>Hadoop 的 checkpoint 流程</li><li>Hadoop 的默认块大小是多少?为什么要设置这么大</li><li>Block 划分的原因</li><li>Hadoop 常见的压缩算法</li><li>Hadoop 作业提交到 YARN 的流程</li><li>Hadoop 的 Combiner 的作用</li><li>Hadoop 序列化和反序列化</li><li>Hadoop 的运行模式</li><li>Hadoop 小文件处理问题</li><li>Hadoop 为什么要从2.x升级到3.x</li><li>HDFS 写流程</li><li>HDFS 读流程</li></ul><h2 id="_1-1-hadoop-quick-start" tabindex="-1"><a class="header-anchor" href="#_1-1-hadoop-quick-start"><span>1.1 Hadoop quick start</span></a></h2><ul><li><p>下载安装包，解压，配置环境变量</p></li><li><p>配置core-site.xml，hdfs-site.xml，mapred-site.xml</p></li><li><p>启动NameNode和DataNode</p></li><li><p>启动YARN</p></li><li><p>运行MapReduce程序</p></li><li><p>通过命令行操作hdfs，如mkdir，put，get，ls，rm等命令</p></li></ul><h2 id="_1-2-hadoop的特点" tabindex="-1"><a class="header-anchor" href="#_1-2-hadoop的特点"><span>1.2 Hadoop的特点</span></a></h2><ul><li>高可靠性</li><li>高效性</li><li>高可扩展性</li><li>高容错性</li><li>低成本</li></ul><h2 id="_1-3-hadoop生态圈组件及其作用" tabindex="-1"><a class="header-anchor" href="#_1-3-hadoop生态圈组件及其作用"><span>1.3 Hadoop生态圈组件及其作用</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1. HDFS (分布式文件系统）</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-4-hadoop-1-x-2x-3-x-的区别" tabindex="-1"><a class="header-anchor" href="#_1-4-hadoop-1-x-2x-3-x-的区别"><span>1.4 Hadoop 1.x，2x，3.x 的区别</span></a></h2><p>Hadoop1.x : MR 处理业务逻辑运算 和 资源的调度，耦合性较大。 Hadoop2.x : 增加了Yarn。Yarn负责资源的调度，MR负责运算。 Hadoop3.x : 在组成上没有变化。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">Hadoop 1.x：</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-6-在集群计算的时候-什么是集群的主要瓶颈" tabindex="-1"><a class="header-anchor" href="#_1-6-在集群计算的时候-什么是集群的主要瓶颈"><span>1.6 在集群计算的时候，什么是集群的主要瓶颈</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">磁盘IO</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-7-搭建hadoop-集群的-xml-文件有哪些" tabindex="-1"><a class="header-anchor" href="#_1-7-搭建hadoop-集群的-xml-文件有哪些"><span>1.7 搭建Hadoop 集群的 xml 文件有哪些</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">core-site.xml      核心配置文件，主要定义文件访问 hdfs://</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-8-hadoop-的-checkpoint-流程" tabindex="-1"><a class="header-anchor" href="#_1-8-hadoop-的-checkpoint-流程"><span>1.8 Hadoop 的 checkpoint 流程</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1. 请求主节点Namenode 停⽌使⽤ editlog⽂件，将新的写操作记录到新⽂件 edits.new。</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-9-hadoop-的默认块大小是多少-为什么要设置这么大" tabindex="-1"><a class="header-anchor" href="#_1-9-hadoop-的默认块大小是多少-为什么要设置这么大"><span>1.9 Hadoop 的默认块大小是多少?为什么要设置这么大</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">Hadoop 1 默认大小 64M</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-10-block-划分的原因" tabindex="-1"><a class="header-anchor" href="#_1-10-block-划分的原因"><span>1.10 Block 划分的原因</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">文件是分布式储存的，被分成块分别储存在不同的机器上。</span>
<span class="line">而多个副本，是为了安全的考虑。</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-11-hadoop常见的压缩算法" tabindex="-1"><a class="header-anchor" href="#_1-11-hadoop常见的压缩算法"><span>1.11 Hadoop常见的压缩算法?</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">gzip, lzo, snappy, bzip2</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="_1-12-hadoop作业提交到yarn的流程" tabindex="-1"><a class="header-anchor" href="#_1-12-hadoop作业提交到yarn的流程"><span>1.12 Hadoop作业提交到YARN的流程?</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">（1）作业提交</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-13-hadoop的combiner的作用" tabindex="-1"><a class="header-anchor" href="#_1-13-hadoop的combiner的作用"><span>1.13 Hadoop的Combiner的作用</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">Combine是作为 Map任务的一部分，在执行完 Map函数后紧接着执行的。能够减少中间结果的数目，从而减少网络流量。</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="_1-14-hadoop序列化和反序列化" tabindex="-1"><a class="header-anchor" href="#_1-14-hadoop序列化和反序列化"><span>1.14 Hadoop序列化和反序列化</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1）序列化：将 结构化对象 转换为 字节流 的过程，以便在网络上传输或写入到磁盘进行永久存储。 </span>
<span class="line">2）反序列化：将 字节流 转回一系列的 结构化对象。 </span>
<span class="line">在Hadoop中，多个节点上进程间的通信是通过“远程过程调用（RPC）”实现的。</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-15-hadoop的运行模式" tabindex="-1"><a class="header-anchor" href="#_1-15-hadoop的运行模式"><span>1.15 Hadoop的运行模式</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1.独立（本地）运行模式：无需任何守护进程，所有的程序都运行在同一个JVM上执行。在独立模式下调试MR程序非常高效方便。所以一般该模式主要是在学习或者开发阶段调试使用 。</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-16-hadoop小文件处理问题" tabindex="-1"><a class="header-anchor" href="#_1-16-hadoop小文件处理问题"><span>1.16 Hadoop小文件处理问题</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">小文件产生的原因</span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-17-hadoop-为什么要从2-x升级到3-x" tabindex="-1"><a class="header-anchor" href="#_1-17-hadoop-为什么要从2-x升级到3-x"><span>1.17 Hadoop 为什么要从2.x升级到3.x</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">存储方面:</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-19-hdfs-读流程" tabindex="-1"><a class="header-anchor" href="#_1-19-hdfs-读流程"><span>1.19 HDFS 读流程</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1. 客户端发起读请求</span>
