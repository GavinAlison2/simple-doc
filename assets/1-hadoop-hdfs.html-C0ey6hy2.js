import{_ as n,c as a,d as e,o as i}from"./app-BLogSpJn.js";const l={};function d(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="hadoop" tabindex="-1"><a class="header-anchor" href="#hadoop"><span>Hadoop</span></a></h1><blockquote><p>hadoop 永远都是这些东西在这里，那就收集一下吧。</p><ol><li>存储， hdfs</li><li>分布式计算，mapreduce</li><li>调度 yarn</li><li>读写流程</li></ol></blockquote><h2 id="_1-hdfs" tabindex="-1"><a class="header-anchor" href="#_1-hdfs"><span>1. hdfs</span></a></h2><blockquote><p>问题：hdfs读写原理，读写流程，hdfs原理，hdfs读写机制，介绍一下hdfs存数据原理，hdfs的put和get流程</p></blockquote><h3 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h3><ul><li>Hadoop quick start</li><li>hadoop 的特点</li><li>hadoop 生态圈组件及其作用</li><li>Hadoop 1.x，2x，3.x 的区别</li><li>Hadoop 集群工作时启动哪些进程,它们有什么作用</li><li>在集群计算的时候，什么是集群的主要瓶颈</li><li>搭建Hadoop 集群的 xml 文件有哪些</li><li>Hadoop 的 checkpoint 流程</li><li>Hadoop 的默认块大小是多少?为什么要设置这么大</li><li>Block 划分的原因</li><li>Hadoop 常见的压缩算法</li><li>Hadoop 作业提交到 YARN 的流程</li><li>Hadoop 的 Combiner 的作用</li><li>Hadoop 序列化和反序列化</li><li>Hadoop 的运行模式</li><li>Hadoop 小文件处理问题</li><li>Hadoop 为什么要从2.x升级到3.x</li><li>HDFS 写流程</li><li>HDFS 读流程</li></ul><h3 id="_1-1-hadoop-quick-start" tabindex="-1"><a class="header-anchor" href="#_1-1-hadoop-quick-start"><span>1.1 Hadoop quick start</span></a></h3><ul><li><p>下载安装包，解压，配置环境变量</p></li><li><p>配置core-site.xml，hdfs-site.xml，mapred-site.xml</p></li><li><p>启动NameNode和DataNode</p></li><li><p>启动YARN</p></li><li><p>运行MapReduce程序</p></li><li><p>通过命令行操作hdfs，如mkdir，put，get，ls，rm等命令</p></li></ul><h3 id="_1-2-hadoop的特点" tabindex="-1"><a class="header-anchor" href="#_1-2-hadoop的特点"><span>1.2 Hadoop的特点</span></a></h3><ul><li>高可靠性</li><li>高效性</li><li>高可扩展性</li><li>高容错性</li><li>低成本</li></ul><h3 id="_1-3-hadoop生态圈组件及其作用" tabindex="-1"><a class="header-anchor" href="#_1-3-hadoop生态圈组件及其作用"><span>1.3 Hadoop生态圈组件及其作用</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1. HDFS (分布式文件系统）</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-4-hadoop-1-x-2x-3-x-的区别" tabindex="-1"><a class="header-anchor" href="#_1-4-hadoop-1-x-2x-3-x-的区别"><span>1.4 Hadoop 1.x，2x，3.x 的区别</span></a></h3><p>Hadoop1.x : MR 处理业务逻辑运算 和 资源的调度，耦合性较大。 Hadoop2.x : 增加了Yarn。Yarn负责资源的调度，MR负责运算。 Hadoop3.x : 在组成上没有变化。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">Hadoop 1.x：</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><table><thead><tr><th>对比维度</th><th>Hadoop 2.x</th><th>Hadoop 3.x</th></tr></thead><tbody><tr><td>存储策略</td><td>默认多副本策略，通常一个数据块有 3 个副本，存储成本高</td><td>引入纠删码技术，在保证数据可靠性的同时，可大幅降低存储成本，提升存储效率</td></tr><tr><td>NameNode 架构</td><td>通过主备两个 NameNode 实现高可用，单一 NameNode 在高并发时可能成为性能瓶颈</td><td>支持多 NameNode 联邦机制，多个 NameNode 同时工作，分散元数据管理压力，提升扩展性和性能</td></tr><tr><td>YARN 资源分配</td><td>资源分配粒度较粗，动态调整能力有限</td><td>支持更细粒度的资源分配，能根据不同任务精确分配资源，提高集群资源利用率</td></tr><tr><td>容器内存管理</td><td>内存管理不够灵活，易出现资源浪费或不足的情况</td><td>引入弹性管理，容器可根据实际负载动态调整内存使用，提高资源利用率</td></tr><tr><td>性能表现</td><td>在大规模数据处理和高并发场景下性能有一定限制</td><td>通过多方面优化，整体性能显著提升，能更快处理大规模数据</td></tr><tr><td>Java 版本支持</td><td>支持相对较旧的 Java 版本</td><td>支持更高版本的 Java，增强与新 Java 特性的兼容性及与其他组件的集成能力</td></tr><tr><td>集群伸缩性</td><td>集群伸缩性较差，节点添加和移除过程复杂</td><td>支持弹性伸缩，可根据负载动态调整集群规模，节点添加和移除更自动化、便捷</td></tr><tr><td>安全特性</td><td>具备基本的安全机制，如 Kerberos 认证等</td><td>进一步加强安全特性，提供更细粒度的访问控制和数据加密，更好地保护数据安全和隐私</td></tr></tbody></table><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">纠删码</span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">2NN 为什么存在？ editlog 和 fsimage 合并的目的是什么？</span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-6-在集群计算的时候-什么是集群的主要瓶颈" tabindex="-1"><a class="header-anchor" href="#_1-6-在集群计算的时候-什么是集群的主要瓶颈"><span>1.6 在集群计算的时候，什么是集群的主要瓶颈</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">磁盘IO</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-7-搭建hadoop-集群的-xml-文件有哪些" tabindex="-1"><a class="header-anchor" href="#_1-7-搭建hadoop-集群的-xml-文件有哪些"><span>1.7 搭建Hadoop 集群的 xml 文件有哪些</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">core-site.xml      核心配置文件，主要定义文件访问 hdfs://</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-8-hadoop-的-checkpoint-流程" tabindex="-1"><a class="header-anchor" href="#_1-8-hadoop-的-checkpoint-流程"><span>1.8 Hadoop 的 checkpoint 流程</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1. 请求主节点Namenode 停⽌使⽤ editlog⽂件，将新的写操作记录到新⽂件 edits.new。</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-9-hadoop-的默认块大小是多少-为什么要设置这么大" tabindex="-1"><a class="header-anchor" href="#_1-9-hadoop-的默认块大小是多少-为什么要设置这么大"><span>1.9 Hadoop 的默认块大小是多少?为什么要设置这么大</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">Hadoop 1 默认大小 64M</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-10-block-划分的原因" tabindex="-1"><a class="header-anchor" href="#_1-10-block-划分的原因"><span>1.10 Block 划分的原因</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">文件是分布式储存的，被分成块分别储存在不同的机器上。</span>
<span class="line">而多个副本，是为了安全的考虑。</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-11-hadoop常见的压缩算法" tabindex="-1"><a class="header-anchor" href="#_1-11-hadoop常见的压缩算法"><span>1.11 Hadoop常见的压缩算法?</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">gzip, lzo, snappy, bzip2</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="_1-12-hadoop作业提交到yarn的流程" tabindex="-1"><a class="header-anchor" href="#_1-12-hadoop作业提交到yarn的流程"><span>1.12 Hadoop作业提交到YARN的流程?</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">（1）作业提交</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-13-hadoop的combiner的作用" tabindex="-1"><a class="header-anchor" href="#_1-13-hadoop的combiner的作用"><span>1.13 Hadoop的Combiner的作用</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">Combine是作为 Map任务的一部分，在执行完 Map函数后紧接着执行的。能够减少中间结果的数目，从而减少网络流量。</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="_1-14-hadoop序列化和反序列化" tabindex="-1"><a class="header-anchor" href="#_1-14-hadoop序列化和反序列化"><span>1.14 Hadoop序列化和反序列化</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1）序列化：将 结构化对象 转换为 字节流 的过程，以便在网络上传输或写入到磁盘进行永久存储。 </span>
<span class="line">2）反序列化：将 字节流 转回一系列的 结构化对象。 </span>
<span class="line">在Hadoop中，多个节点上进程间的通信是通过“远程过程调用（RPC）”实现的。</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-15-hadoop的运行模式" tabindex="-1"><a class="header-anchor" href="#_1-15-hadoop的运行模式"><span>1.15 Hadoop的运行模式</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1.独立（本地）运行模式：无需任何守护进程，所有的程序都运行在同一个JVM上执行。在独立模式下调试MR程序非常高效方便。所以一般该模式主要是在学习或者开发阶段调试使用 。</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-16-hadoop小文件处理问题" tabindex="-1"><a class="header-anchor" href="#_1-16-hadoop小文件处理问题"><span>1.16 Hadoop小文件处理问题</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">小文件产生的原因</span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-17-hadoop-为什么要从2-x升级到3-x" tabindex="-1"><a class="header-anchor" href="#_1-17-hadoop-为什么要从2-x升级到3-x"><span>1.17 Hadoop 为什么要从2.x升级到3.x</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">存储方面:</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-18-hdfs写流程" tabindex="-1"><a class="header-anchor" href="#_1-18-hdfs写流程"><span>1.18 HDFS写流程</span></a></h3><p>1）client客户端发送上传请求，通过RPC与namenode建立通信，namenode检查该用户是否有上传权限，以及上传的文件是否在hdfs对应的目录下重名，如果这两者有任意一个不满足，则直接报错，如果两者都满足，则返回给客户端一个可以上传的信息</p><p>client -&gt; namenode , 检查权限和文件名</p><p>2）client根据文件的大小进行切分，默认128M一块，切分完成之后给namenode发送请求第一个block块上传到哪些服务器上</p><p>client -&gt; namenode , 切分文件块, 默认最大128M</p><p>3）namenode收到请求之后，根据网络拓扑和机架感知以及副本机制进行文件分配，返回可用的DataNode的地址</p><p>namenode -&gt; datanode, 选择 DataNode</p><p>注：Hadoop 在设计时考虑到数据的安全与高效, 数据文件默认在 HDFS 上存放三份, 存储策略为本地一份，同机架内其它某一节点上一份, 不同机架的某一节点上一份</p><p>4）客户端收到地址之后与服务器地址列表中的一个节点如A进行通信，本质上就是RPC调用，建立pipeline，A收到请求后会继续调用B，B在调用C，将整个pipeline建立完成，逐级返回client</p><p>5）client开始向A上发送第一个block（先从磁盘读取数据然后放到本地内存缓存），以packet（数据包，64kb）为单位，A收到一个packet就会发送给B，然后B发送给C，A每传完一个packet就会放入一个应答队列等待应答</p><p>6）数据被分割成一个个的packet数据包在pipeline上依次传输，在pipeline反向传输中，逐个发送ack（命令正确应答），最终由pipeline 中第一个 DataNode 节点 A 将 pipeline ack 发送给 Client</p><p>7）当一个 block 传输完成之后, Client 再次请求 NameNode 上传第二个 block ，namenode重新选择三台DataNode给client</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1. 客户端发起创建文件请求</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">客户端 -- 创建文件请求 --&gt; NameNode</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-19-hdfs-读流程" tabindex="-1"><a class="header-anchor" href="#_1-19-hdfs-读流程"><span>1.19 HDFS 读流程</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">1. 客户端发起读请求</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">HDFS 的读流程主要涉及客户端、NameNode 和 DataNode 之间的交互。</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,61)]))}const r=n(l,[["render",d]]),o=JSON.parse('{"path":"/guide/etl/1-hadoop-hdfs.html","title":"Hadoop","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"1. hdfs","slug":"_1-hdfs","link":"#_1-hdfs","children":[{"level":3,"title":"目录","slug":"目录","link":"#目录","children":[]},{"level":3,"title":"1.1   Hadoop quick start","slug":"_1-1-hadoop-quick-start","link":"#_1-1-hadoop-quick-start","children":[]},{"level":3,"title":"1.2 Hadoop的特点","slug":"_1-2-hadoop的特点","link":"#_1-2-hadoop的特点","children":[]},{"level":3,"title":"1.3 Hadoop生态圈组件及其作用","slug":"_1-3-hadoop生态圈组件及其作用","link":"#_1-3-hadoop生态圈组件及其作用","children":[]},{"level":3,"title":"1.4 Hadoop 1.x，2x，3.x 的区别","slug":"_1-4-hadoop-1-x-2x-3-x-的区别","link":"#_1-4-hadoop-1-x-2x-3-x-的区别","children":[]},{"level":3,"title":"1.5 Hadoop集群工作时启动哪些进程,它们有什么作用","slug":"_1-5-hadoop集群工作时启动哪些进程-它们有什么作用","link":"#_1-5-hadoop集群工作时启动哪些进程-它们有什么作用","children":[]},{"level":3,"title":"1.6 在集群计算的时候，什么是集群的主要瓶颈","slug":"_1-6-在集群计算的时候-什么是集群的主要瓶颈","link":"#_1-6-在集群计算的时候-什么是集群的主要瓶颈","children":[]},{"level":3,"title":"1.7 搭建Hadoop 集群的 xml 文件有哪些","slug":"_1-7-搭建hadoop-集群的-xml-文件有哪些","link":"#_1-7-搭建hadoop-集群的-xml-文件有哪些","children":[]},{"level":3,"title":"1.8 Hadoop 的 checkpoint 流程","slug":"_1-8-hadoop-的-checkpoint-流程","link":"#_1-8-hadoop-的-checkpoint-流程","children":[]},{"level":3,"title":"1.9 Hadoop 的默认块大小是多少?为什么要设置这么大","slug":"_1-9-hadoop-的默认块大小是多少-为什么要设置这么大","link":"#_1-9-hadoop-的默认块大小是多少-为什么要设置这么大","children":[]},{"level":3,"title":"1.10 Block 划分的原因","slug":"_1-10-block-划分的原因","link":"#_1-10-block-划分的原因","children":[]},{"level":3,"title":"1.11 Hadoop常见的压缩算法?","slug":"_1-11-hadoop常见的压缩算法","link":"#_1-11-hadoop常见的压缩算法","children":[]},{"level":3,"title":"1.12 Hadoop作业提交到YARN的流程?","slug":"_1-12-hadoop作业提交到yarn的流程","link":"#_1-12-hadoop作业提交到yarn的流程","children":[]},{"level":3,"title":"1.13 Hadoop的Combiner的作用","slug":"_1-13-hadoop的combiner的作用","link":"#_1-13-hadoop的combiner的作用","children":[]},{"level":3,"title":"1.14 Hadoop序列化和反序列化","slug":"_1-14-hadoop序列化和反序列化","link":"#_1-14-hadoop序列化和反序列化","children":[]},{"level":3,"title":"1.15 Hadoop的运行模式","slug":"_1-15-hadoop的运行模式","link":"#_1-15-hadoop的运行模式","children":[]},{"level":3,"title":"1.16 Hadoop小文件处理问题","slug":"_1-16-hadoop小文件处理问题","link":"#_1-16-hadoop小文件处理问题","children":[]},{"level":3,"title":"1.17 Hadoop 为什么要从2.x升级到3.x","slug":"_1-17-hadoop-为什么要从2-x升级到3-x","link":"#_1-17-hadoop-为什么要从2-x升级到3-x","children":[]},{"level":3,"title":"1.18 HDFS写流程","slug":"_1-18-hdfs写流程","link":"#_1-18-hdfs写流程","children":[]},{"level":3,"title":"1.19 HDFS 读流程","slug":"_1-19-hdfs-读流程","link":"#_1-19-hdfs-读流程","children":[]}]}],"git":{},"filePathRelative":"guide/etl/1-hadoop-hdfs.md"}');export{r as comp,o as data};
