import{_ as n,c as i,e,o as a}from"./app-DKrcH86L.js";const l={};function d(p,s){return a(),i("div",null,s[0]||(s[0]=[e(`<h1 id="环境搭建" tabindex="-1"><a class="header-anchor" href="#环境搭建"><span>环境搭建</span></a></h1><h2 id="安装系统" tabindex="-1"><a class="header-anchor" href="#安装系统"><span>安装系统</span></a></h2><ol><li>安装centos7系统</li><li>配置好网络</li><li>配置yum源</li><li>安装git</li><li>安装node.js, python, docker 等软件</li></ol><p>其中对应的脚本文件如下：</p><p>1-modify_font.sh</p><div class="language-modify_font.sh line-numbers-mode" data-highlighter="prismjs" data-ext="modify_font.sh"><pre><code><span class="line">#!/bin/bash</span>
