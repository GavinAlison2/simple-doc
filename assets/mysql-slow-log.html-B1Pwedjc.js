import{_ as n,c as a,e,o as l}from"./app-DN6Q4pKI.js";const i={};function p(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="mysql慢日志" tabindex="-1"><a class="header-anchor" href="#mysql慢日志"><span>MySQL慢日志</span></a></h1><h2 id="pt-query-digest" tabindex="-1"><a class="header-anchor" href="#pt-query-digest"><span>pt-query-digest</span></a></h2><div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre><code><span class="line">pt-query-digest 属于 Percona Toolkit 的一个工具，也是使用较多的一个；</span>
