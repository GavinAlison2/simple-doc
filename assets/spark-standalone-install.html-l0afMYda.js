import{_ as n,c as a,d as e,o as l}from"./app-BSIdeD4V.js";const i={};function r(p,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="spark-standalone-installation" tabindex="-1"><a class="header-anchor" href="#spark-standalone-installation"><span>Spark Standalone Installation</span></a></h1><p>独立部署（Standalone）模式。Spark 的 Standalone 模式体现了经典的 master-slave 模式。 master node: 负责调度 worker node: 负责执行任务</p><p>集群规划:</p><ul><li>linux1, worker1, master</li><li>linux2, worker2</li><li>linux3, worker3</li></ul><h2 id="准备工作" tabindex="-1"><a class="header-anchor" href="#准备工作"><span>准备工作</span></a></h2><ul><li>安装JDK</li><li>安装Spark</li><li>配置环境变量</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">vi /etc/hosts</span>
