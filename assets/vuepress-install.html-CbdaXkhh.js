import{_ as n,c as a,e,o as i}from"./app-DlGl6QFf.js";const l="/simple-doc/assets/github-pages-CnaJ0gja.png",p="/simple-doc/assets/actions-CkbYltt_.png",c={};function t(d,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="vuepress-安装" tabindex="-1"><a class="header-anchor" href="#vuepress-安装"><span>VuePress 安装</span></a></h1><h2 id="注意" tabindex="-1"><a class="header-anchor" href="#注意"><span>注意</span></a></h2><p>该项目需要在 node-v2.18.0 以上版本运行，否则会报错。</p><p><code>nvm use 20.18.0</code></p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"><span class="token function">npm</span> init vuepress vuepress-starter</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-部署网站文件到-github-仓库-simple-doc-的-gh-pages-分支" tabindex="-1"><a class="header-anchor" href="#_2-部署网站文件到-github-仓库-simple-doc-的-gh-pages-分支"><span>2. 部署网站文件到 github 仓库 simple-doc 的 gh-pages 分支</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"><span class="token shebang important">#!/usr/bin/env sh</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中 <code>\${GITHUB_TOKEN}</code> 是 github 仓库的 <code>secrets</code> 设置，用于自动部署。</p><p>提交代码到 master 分支，github actions 会自动部署网站到 gh-pages 分支。</p><p>在 github pages 设置中，将 <code>source</code> 选择 <code>gh-pages</code> 分支，然后点击 <code>save</code> 保存设置。 <img src="`+l+'" alt="pages"></p><p>github actions 相当于 CI/CD 工具，可以自动化部署网站。</p><p>推送成功之后可以看到部署过程，先 工作流指定的名称， 然后系统默认的部署工作流</p><p><img src="'+p+'" alt="actions"></p><p>最后访问： https://gavinalison2.github.io/simple-doc/</p><h2 id="本地调试" tabindex="-1"><a class="header-anchor" href="#本地调试"><span>本地调试</span></a></h2><p>运行 <code>npm run docs:dev</code> 启动本地调试服务器，浏览器访问 http://localhost:8080 即可看到本地调试的网站。</p><p>参考：</p><ol><li>https://juejin.cn/column/7041871760995647502</li><li>https://vuepress.vuejs.org/zh/guide/getting-started.html</li></ol>',32)]))}const u=n(c,[["render",t]]),r=JSON.parse('{"path":"/pages/vuepress/vuepress-install.html","title":"VuePress 安装","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"注意","slug":"注意","link":"#注意","children":[]},{"level":2,"title":"使用","slug":"使用","link":"#使用","children":[]},{"level":2,"title":"构建你的网站","slug":"构建你的网站","link":"#构建你的网站","children":[]},{"level":2,"title":"部署 github pages","slug":"部署-github-pages","link":"#部署-github-pages","children":[{"level":3,"title":"1. 添加源码到 github 仓库","slug":"_1-添加源码到-github-仓库","link":"#_1-添加源码到-github-仓库","children":[]},{"level":3,"title":"2. 部署网站文件到 github 仓库 simple-doc 的 gh-pages 分支","slug":"_2-部署网站文件到-github-仓库-simple-doc-的-gh-pages-分支","link":"#_2-部署网站文件到-github-仓库-simple-doc-的-gh-pages-分支","children":[]}]},{"level":2,"title":"使用 github actions 自动部署","slug":"使用-github-actions-自动部署","link":"#使用-github-actions-自动部署","children":[]},{"level":2,"title":"本地调试","slug":"本地调试","link":"#本地调试","children":[]}],"git":{"updatedTime":1753236131000,"contributors":[{"name":"alice","username":"alice","email":"921757697@qq.com","commits":2,"url":"https://github.com/alice"}],"changelog":[{"hash":"5ab09e6e2b722a11620cdfb7761866fc10068022","time":1753236131000,"email":"921757697@qq.com","author":"alice","message":"deploy uniapp 组件"},{"hash":"bab5e937f8ab6634c5d1998c279dabfc6cf18298","time":1743496862000,"email":"921757697@qq.com","author":"alice","message":"deploy-5"}]},"filePathRelative":"pages/vuepress/vuepress-install.md"}');export{u as comp,r as data};
