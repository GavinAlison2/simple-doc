import{_ as n,c as e,e as a,o as i}from"./app-CdVidjIO.js";const l={};function t(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h1 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h1><ol><li>表格的行 和 button 不对齐</li></ol><p>配置 css</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">.todo-item{</span>
