<template><div><h1 id="yarn" tabindex="-1"><a class="header-anchor" href="#yarn"><span>Yarn</span></a></h1>
<h2 id="_1-从流程角度来理解-yarn-划分组件" tabindex="-1"><a class="header-anchor" href="#_1-从流程角度来理解-yarn-划分组件"><span>1. 从流程角度来理解 YARN 划分组件</span></a></h2>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">YARN 的设计思路是将资源管理和任务调度从具体的计算框架中分离出来，形成一个通用的资源管理系统，以支持多种不同类型的应用程序在集群上运行。</span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">应用提交与 ApplicationMaster 启动</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-yarn-的主要组件包括" tabindex="-1"><a class="header-anchor" href="#_2-yarn-的主要组件包括"><span>2. YARN 的主要组件包括：</span></a></h2>
<ul>
<li>ResourceManager (RM): 负责集群资源的分配和调度。</li>
<li>NodeManager (NM): 负责每个节点上的资源管理和任务执行。</li>
<li>ApplicationMaster (AM): 负责向 ResourceManager 申请资源，并在 NM 上启动 ApplicationMaster。</li>
<li>Container: 一个运行在 YARN 集群中的任务，由 ApplicationMaster 启动。</li>
</ul>
<p>YARN 的架构如下图所示：</p>
<p><img src="https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/yarn_architecture.gif" alt="YARN 架构"></p>
<p>YARN 的主要功能包括：</p>
<ul>
<li>资源管理：ResourceManager 负责集群资源的分配和调度，包括分配内存、CPU、磁盘等资源，并将这些资源分配给各个 NodeManager。</li>
<li>任务调度：ResourceManager 根据各个 ApplicationMaster 的资源需求，将任务调度到各个 NodeManager 上。</li>
<li>容错：ResourceManager 和 NodeManager 都有容错机制，可以自动检测和恢复失败的节点。</li>
<li>弹性：ResourceManager 和 NodeManager 可以动态增加和减少，以应对集群的变化。</li>
<li>应用编程接口：YARN 提供了丰富的应用编程接口 (API)，支持多种类型的应用程序，如 MapReduce、Spark、Hadoop Streaming、Pig、Hive 等。</li>
<li>安全：YARN 支持 Kerberos 安全认证，并提供基于角色的访问控制 (RBAC) 机制。</li>
<li>可视化：YARN 提供了 Web 界面，方便管理员和用户查看集群的状态。</li>
</ul>
<h2 id="_3-yarn-的优点" tabindex="-1"><a class="header-anchor" href="#_3-yarn-的优点"><span>3. YARN 的优点：</span></a></h2>
<ul>
<li>资源隔离：YARN 提供了资源隔离机制，可以将不同应用的资源隔离到不同的队列中，实现资源共享和独占。</li>
</ul>
<h2 id="_4-yarn工作机制" tabindex="-1"><a class="header-anchor" href="#_4-yarn工作机制"><span>4. YARN工作机制</span></a></h2>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">1. 用户向 Yarn 中提交一个 MR 任务</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-yarn有什么优势-能解决什么问题" tabindex="-1"><a class="header-anchor" href="#_5-yarn有什么优势-能解决什么问题"><span>5. YARN有什么优势，能解决什么问题?</span></a></h2>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">1、YARN的设计减小了JobTracker的资源消耗，减少单点故障，并且让监测每一个Job子任务(tasks)状态的程序分布式化了，更安全、更优美。</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-yarn容错机制" tabindex="-1"><a class="header-anchor" href="#_6-yarn容错机制"><span>6. YARN容错机制</span></a></h2>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">1. ApplicationMaster 容错：RM 监控 AM 的运行状态，一旦发现它运行失败或者超时，就会重新分配资源并启动它，启动之后AM内部的状态如何恢复由自己保证，</span>
