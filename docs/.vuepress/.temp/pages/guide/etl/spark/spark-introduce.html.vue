<template><div><h1 id="spark" tabindex="-1"><a class="header-anchor" href="#spark"><span>Spark</span></a></h1>
...
<!-- /TOC -->
<h2 id="spark-简介" tabindex="-1"><a class="header-anchor" href="#spark-简介"><span>Spark 简介</span></a></h2>
<h3 id="spark-概念" tabindex="-1"><a class="header-anchor" href="#spark-概念"><span>Spark 概念</span></a></h3>
<ul>
<li>大规模分布式通用计算引擎
<ul>
...
<h3 id="spark-特点" tabindex="-1"><a class="header-anchor" href="#spark-特点"><span>Spark 特点</span></a></h3>
<ul>
<li>计算高效
<ul>
...
<h2 id="spark-原理" tabindex="-1"><a class="header-anchor" href="#spark-原理"><span>Spark 原理</span></a></h2>
<h3 id="编程模型" tabindex="-1"><a class="header-anchor" href="#编程模型"><span>编程模型</span></a></h3>
<h4 id="rdd" tabindex="-1"><a class="header-anchor" href="#rdd"><span>RDD</span></a></h4>
<ul>
...
<h4 id="rdd-操作-operator" tabindex="-1"><a class="header-anchor" href="#rdd-操作-operator"><span>RDD 操作（Operator）</span></a></h4>
<ul>
...
<h4 id="rdd-依赖-dependency" tabindex="-1"><a class="header-anchor" href="#rdd-依赖-dependency"><span>RDD 依赖（Dependency）</span></a></h4>
<ul>
